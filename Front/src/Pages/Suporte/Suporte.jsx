    ...
    <div>
      ...
      <main className="mt-16 p-8 bg-gray-50 min-h-screen">
        <section className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
          <h1 className="text-4xl font-bold text-center mb-12 text-indigo-600">Suporte</h1>
          
          
          <div className="mb-16">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Perguntas Frequentes</h2>
            <div className="space-y-8">
              <div className="bg-gray-100 p-6 rounded-md">
                <h3 className="text-xl font-semibold text-gray-700">Como posso fazer x?</h3>
                <p className="text-gray-600 mt-2">Você pode fazer x seguindo as instruções.</p>
              </div>
              <div className="bg-gray-100 p-6 rounded-md">
                <h3 className="text-xl font-semibold text-gray-700">Como faco algo?</h3>
                <p className="text-gray-600 mt-2">Aqui está a explicação de como fazer algo.</p>
              </div>
              <div className="bg-gray-100 p-6 rounded-md">
                <h3 className="text-xl font-semibold text-gray-700">Como entro em contato com o suporte técnico?</h3>
          ...
          <div>
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Entre em Contato</h2>
